...
public class CS60810Bashikari {
    ...
    static int findIndex(Integer[] CBSTree, int index) {
    ...
    static int situationCBS(int np, int dp, int index, Integer[] CBSTree, int last, int subMax) {
    ...
    static int situation1CBS(int np, int dp, int last, Integer[] CBSTree, int subMax) {
    	//moves from DP to NP
    ...
    static int situation2CBS(int np, int dp, int last, Integer[] CBSTree, int subMax) {
    	//moves from NP to DP
    ...
    static void inorder(Integer[] CBSTree, int sub, int subLast) {
    ...
    static int nextInInorder(int sub, int subMax, int subLast) {
    ...
    static Integer[] constructCBS(int[] data) {
    	
    	Integer[] CBSTree = new Integer[data.length + 1];
    	...
    	int k = 0; //num of elements within the CBS tree array
    	...
    	//If NP <= 2 * index + 1, then NP is on the last level (situation 1). Otherwise, it is on the next level.
	...
	public static void main(String[] args) throws Exception {
		...
		Integer[] CBSTree = new Integer[lengthCount + 1];
		...
		//Calculate the time that is taken to search each tree for all 10 keys. Not each key... three times, one for each tree.
